...
func NewServer(nodeId string, bindAddr string, grpcAddr string, httpAddr string, dataDir string, peerAddr string, logger *log.Logger, httpLogger accesslog.Logger) (*Server, error) {
	var err error
