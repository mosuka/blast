...
func NewGetIndexHandler(c *client.BlastClient) *GetIndexHandler {
...
func (h *GetIndexHandler) ServeHTTP(w http.ResponseWriter, req *http.Request) {
	...
	// request
	resp, err := h.client.GetIndex(includeIndexMapping, includeIndexType, includeKvstore, includeKvconfig)
	if err != nil {
		log.WithFields(log.Fields{
			"err": err,
