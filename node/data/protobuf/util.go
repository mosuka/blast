...
func init() {
	...
	registry.RegisterType("protobuf.Metadata", reflect.TypeOf(Metadata{}))
	registry.RegisterType("protobuf.PutDocumentRequest", reflect.TypeOf(PutDocumentRequest{}))
	registry.RegisterType("protobuf.DeleteDocumentRequest", reflect.TypeOf(DeleteDocumentRequest{}))
	registry.RegisterType("protobuf.BulkUpdateRequest", reflect.TypeOf(BulkUpdateRequest{}))
}
...
//	}
//
//	fieldsInstance, err := MarshalAny(m.Fields)
//	if err != nil {
//		return nil, err
//	}
//
...
//	}
//
//	return fieldsInstance.(map[string]interface{}), nil
//}

//func (m *Document) GetMap() {
//
//}

// ----------------------------------------

//func (m *GetDocumentResponse) GetFieldsMap() (map[string]interface{}, error) {
//	var err error
//
//	if m == nil {
//		return nil, nil
...
//func (m *GetDocumentResponse) GetBytes() ([]byte, error) {
//	var err error
//
//	if m == nil {
//		return nil, nil
...
//func (m *SearchDocumentsRequest) SetBytes(searchRequestBytes []byte) error {
//	var err error
//
//	if m == nil {
//		return nil
...
//func (m *SearchDocumentsRequest) SetMap(searchRequestMap map[string]interface{}) error {
//	var err error
//
//	if m == nil {
//		return nil
...
//func (m *SearchDocumentsResponse) GetBytes() ([]byte, error) {
//	var err error
//
//	if m == nil {
//		return nil, nil
